  ...
  if (variant === "compact") {
    return (
      <div className="flex items-start gap-3 rounded-lg border border-border/60 bg-muted/30 px-4 py-3 text-xs text-muted-foreground">
        ...
        <p>
          Read-only projection. Canonical Knowledge Objects are authored outside
          this interface — no create, edit, delete, approve or publish actions
          exist by design.
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground">
        Hidden Grain is a read-only projection of a canonical knowledge repository.
        The frontend never mutates state — it observes.
      </p>
